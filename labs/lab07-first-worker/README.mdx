...
> **Behavior note.** The worker code is the complete Labs 07–14
> implementation. Earlier README versions called this section "stub
> verification" and expected 501; the actual handlers are wired and
> the auth/binding guards activate first, so 401/400 is what you see
> in Lab 07 state.
