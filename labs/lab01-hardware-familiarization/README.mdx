...
If you chose **Local Dev Container** or **Codespace**, verify the engagement
stack inside the operator console:
...
If you chose **Minimal local**, only verify the rootfs is present on your
...
> Step 3. Codespace students should run this alongside the laptop terminal — the
> Codespace can't drive failsafe.
